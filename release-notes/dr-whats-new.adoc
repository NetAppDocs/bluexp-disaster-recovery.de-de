...
* *Aktualisierungen des Replikationsplans*: Sie können einen Replikationsplan einfacher hinzufügen, indem Sie VMs auf der Seite Anwendungen nach Datastore filtern und auf der Seite Ressourcenzuordnung weitere Zieldetails auswählen.
+
