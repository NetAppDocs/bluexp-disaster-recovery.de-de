...
Die Vollversion des Disaster Recovery-Service von BlueXP kann mit einer NetApp Lizenz genutzt werden.
...
Um nach der 90-Tage-Testsoftware fortzufahren, müssen Sie eine BYOL-Lizenz von NetApp erwerben.
...
image:dr-architecture-diagram-onprem-to-onprem2.png["Diagramm mit der Architektur der BlueXP Disaster Recovery für VMware Service-Infrastruktur"]
